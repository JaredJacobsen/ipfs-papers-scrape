...
;// CONCATENATED MODULE: ./src/functions/get-options.js
...
function _getOptions() {
  _getOptions = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee() {
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee() {
  var options, response, responseClone, isUrlAPdf, message;
  return regenerator_default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          _context.next = 6;
          return fetch(options && options.indirectFetch ? options.url : location.href);
